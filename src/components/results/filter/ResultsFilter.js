...
import {
  selectSearchName,
  selectMinSearchAmount,
  selectMaxSearchAmount,
    ...
    <div className="filter-bloc">
      <div className="filter-tabs">
        <div className="filter-tabs-container">
          <FilterPlaceTab placeholder="Update place" />
          <FilterTab
          ...
          <FilterTab
            ...
            medium
          />
          <button className="filter-save-btn">Enregistrer</button>
        </div>
      </div>
      <div className="tabs-content">
        <div className={`tabs-content-wrapper ${sale ? "hidden" : ""}`}>
          <div
            className={`tabs-content-wrapper-radio ${
              sellType === "rent" ? "rent" : ""
            }`}
            onClick={() => setSearchName("rent")}
          >
            <span>Louer</span>
          </div>
          <div
            ...
            onClick={() => setSearchName("buy")}
          >
            <span>Acheter</span>
          </div>
          <ValidateChoiceBar disableFilter={disableFilterState} />
        </div>
